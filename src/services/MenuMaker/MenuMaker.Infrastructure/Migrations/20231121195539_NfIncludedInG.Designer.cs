...
namespace MenuMaker.Infrastructure.Migrations
{
    ...
    [Migration("20231121195539_NfIncludedInG")]
    partial class NfIncludedInG
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MenuMaker.Domain.Models.Recipes.Grocery", b =>
                {
                    ...
                    b.OwnsOne("MenuMaker.Domain.Models.Recipes.NutritionFacts", "NutritionFacts", b1 =>
                        {
                            ...
                            b1.OwnsOne("MenuMaker.Domain.Models.Recipes.ValueObjects.UnitValue", "ServingSize", b2 =>
                                {
